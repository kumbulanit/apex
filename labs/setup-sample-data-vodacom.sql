...
-- idx_mobile_sim removed: sim_card_number UNIQUE constraint already creates an index
-- idx_pkg_category removed: category column does not exist on vodacom_packages
...
-- idx_vodapay_customer removed: customer_id UNIQUE constraint already creates an index
-- idx_vodapay_wallet removed: wallet_number UNIQUE constraint already creates an index
...
-- ============================================================================
-- DELETE ALL DATA (ensures clean re-run if tables already have data)
-- Child tables first (FK order), then parent tables
-- Uses DELETE (not TRUNCATE) to respect FK constraints
-- ============================================================================
BEGIN
    EXECUTE IMMEDIATE 'DELETE FROM vodacom_invoice_items';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
    EXECUTE IMMEDIATE 'DELETE FROM vodacom_invoices';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
    EXECUTE IMMEDIATE 'DELETE FROM vodacom_vodapay_accounts';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
    EXECUTE IMMEDIATE 'DELETE FROM vodacom_sales';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
    EXECUTE IMMEDIATE 'DELETE FROM vodacom_customer_support';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
    EXECUTE IMMEDIATE 'DELETE FROM vodacom_network_issues';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
    EXECUTE IMMEDIATE 'DELETE FROM vodacom_network_towers';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
    EXECUTE IMMEDIATE 'DELETE FROM vodacom_transactions';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
    EXECUTE IMMEDIATE 'DELETE FROM vodacom_packages';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
    EXECUTE IMMEDIATE 'DELETE FROM vodacom_mobile_numbers';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
BEGIN
    EXECUTE IMMEDIATE 'DELETE FROM vodacom_customers';
EXCEPTION WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
  INSERT INTO vodacom_customers (account_number, first_name, last_name, id_number, email, phone, address_line1, city, province, postal_code, customer_type, credit_limit, assigned_agent_id, vodapay_active)
...
BEGIN
  INSERT INTO vodacom_mobile_numbers (mobile_number, customer_id, number_type, sim_card_number, activation_date, current_package, monthly_fee, data_balance_mb, airtime_balance, sms_balance)
  VALUES ('0821234567', 1, 'Postpaid', 'SIM-8927100012345678901', DATE '2022-01-15', 'Smart XL', 0, 5120, 0, 0);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_mobile_numbers (mobile_number, customer_id, number_type, sim_card_number, activation_date, current_package, monthly_fee, data_balance_mb, airtime_balance, sms_balance)
  VALUES ('0839876543', 2, 'Prepaid', 'SIM-8927100098765432109', DATE '2021-06-20', NULL, 0, 850, 45.50, 25);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
...
BEGIN
  INSERT INTO vodacom_mobile_numbers (mobile_number, customer_id, number_type, sim_card_number, activation_date, current_package, monthly_fee, data_balance_mb, airtime_balance, sms_balance)
  VALUES ('0734567890', 4, 'Prepaid', 'SIM-8927100022222333344', DATE '2023-03-05', NULL, 0, 0, 12.00, 5);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_mobile_numbers (mobile_number, customer_id, number_type, sim_card_number, activation_date, current_package, monthly_fee, data_balance_mb, airtime_balance, sms_balance)
  VALUES ('0827654321', 5, 'Postpaid', 'SIM-8927100033333444455', DATE '2021-09-12', 'Smart L', 0, 3072, 0, 0);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_mobile_numbers (mobile_number, customer_id, number_type, sim_card_number, activation_date, current_package, monthly_fee, data_balance_mb, airtime_balance, sms_balance)
  VALUES ('0789012345', 9, 'Prepaid', 'SIM-8927100044444555566', DATE '2022-07-18', NULL, 0, 1500, 85.00, 50);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_mobile_numbers (mobile_number, customer_id, number_type, sim_card_number, activation_date, current_package, monthly_fee, data_balance_mb, airtime_balance, sms_balance)
  VALUES ('0736789012', 10, 'Prepaid', 'SIM-8927100055555666677', DATE '2023-01-22', NULL, 0, 2048, 120.00, 100);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
...
BEGIN
  INSERT INTO vodacom_mobile_numbers (mobile_number, customer_id, number_type, sim_card_number, activation_date, current_package, monthly_fee, data_balance_mb, airtime_balance, sms_balance)
  VALUES ('0739876543', 12, 'Prepaid', 'SIM-8927100077777888899', DATE '2022-10-30', NULL, 0, 500, 30.00, 10);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_mobile_numbers (mobile_number, customer_id, number_type, sim_card_number, activation_date, current_package, monthly_fee, data_balance_mb, airtime_balance, sms_balance)
  VALUES ('0756781234', 13, 'Postpaid', 'SIM-8927100088888999900', DATE '2020-08-14', 'Smart M', 0, 2048, 0, 0);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_mobile_numbers (mobile_number, customer_id, number_type, sim_card_number, activation_date, current_package, monthly_fee, data_balance_mb, airtime_balance, sms_balance)
  VALUES ('0789011111', 15, 'Prepaid', 'SIM-8927100099999000011', DATE '2023-02-05', NULL, 0, 3072, 150.00, 75);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
...
BEGIN
  INSERT INTO vodacom_mobile_numbers (mobile_number, customer_id, number_type, sim_card_number, activation_date, current_package, monthly_fee, data_balance_mb, airtime_balance, sms_balance)
  VALUES ('0733334444', 19, 'Prepaid', 'SIM-8927100020202020202', DATE '2022-05-15', NULL, 0, 256, 18.50, 8);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_mobile_numbers (mobile_number, customer_id, number_type, sim_card_number, activation_date, current_package, monthly_fee, data_balance_mb, airtime_balance, sms_balance)
  VALUES ('0765555666', 20, 'Prepaid', 'SIM-8927100030303030303', DATE '2023-04-10', NULL, 0, 512, 55.00, 20);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_mobile_numbers (mobile_number, customer_id, number_type, sim_card_number, activation_date, current_package, monthly_fee, data_balance_mb, airtime_balance, sms_balance)
  VALUES ('0826667777', 21, 'Postpaid', 'SIM-8927100040404040404', DATE '2021-07-25', 'Smart L', 0, 3072, 0, 0);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
...
BEGIN
  INSERT INTO vodacom_packages (package_code, package_name, description, package_type, data_allocation_mb, voice_minutes, sms_count, price, validity_days, is_promotional, promo_price, promo_start_date, promo_end_date)
  VALUES ('DATA-DAILY-50', 'Daily 50MB', '50MB data valid for 24 hours', 'Data Only', 50, NULL, NULL, 10, 1, 'N', NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_packages (package_code, package_name, description, package_type, data_allocation_mb, voice_minutes, sms_count, price, validity_days, is_promotional, promo_price, promo_start_date, promo_end_date)
  VALUES ('DATA-DAILY-250', 'Daily 250MB', '250MB data valid for 24 hours', 'Data Only', 250, NULL, NULL, 25, 1, 'N', NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_packages (package_code, package_name, description, package_type, data_allocation_mb, voice_minutes, sms_count, price, validity_days, is_promotional, promo_price, promo_start_date, promo_end_date)
  VALUES ('DATA-WEEKLY-1G', 'Weekly 1GB', '1GB data valid for 7 days', 'Data Only', 1024, NULL, NULL, 75, 7, 'N', NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_packages (package_code, package_name, description, package_type, data_allocation_mb, voice_minutes, sms_count, price, validity_days, is_promotional, promo_price, promo_start_date, promo_end_date)
  VALUES ('DATA-WEEKLY-2G', 'Weekly 2GB', '2GB data valid for 7 days', 'Data Only', 2048, NULL, NULL, 135, 7, 'N', NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_packages (package_code, package_name, description, package_type, data_allocation_mb, voice_minutes, sms_count, price, validity_days, is_promotional, promo_price, promo_start_date, promo_end_date)
  VALUES ('DATA-MONTHLY-1G', 'Monthly 1GB', '1GB data valid for 30 days', 'Data Only', 1024, NULL, NULL, 149, 30, 'Y', 99, DATE '2024-01-01', DATE '2024-12-31');
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_packages (package_code, package_name, description, package_type, data_allocation_mb, voice_minutes, sms_count, price, validity_days, is_promotional, promo_price, promo_start_date, promo_end_date)
  VALUES ('DATA-MONTHLY-2G', 'Monthly 2GB', '2GB data valid for 30 days', 'Data Only', 2048, NULL, NULL, 249, 30, 'N', NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_packages (package_code, package_name, description, package_type, data_allocation_mb, voice_minutes, sms_count, price, validity_days, is_promotional, promo_price, promo_start_date, promo_end_date)
  VALUES ('DATA-MONTHLY-5G', 'Monthly 5GB', '5GB data valid for 30 days', 'Data Only', 5120, NULL, NULL, 499, 30, 'N', NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_packages (package_code, package_name, description, package_type, data_allocation_mb, voice_minutes, sms_count, price, validity_days, is_promotional, promo_price, promo_start_date, promo_end_date)
  VALUES ('DATA-MONTHLY-10G', 'Monthly 10GB', '10GB data valid for 30 days', 'Data Only', 10240, NULL, NULL, 849, 30, 'N', NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_packages (package_code, package_name, description, package_type, data_allocation_mb, voice_minutes, sms_count, price, validity_days, is_promotional, promo_price, promo_start_date, promo_end_date)
  VALUES ('DATA-MONTHLY-20G', 'Monthly 20GB', '20GB data valid for 30 days', 'Data Only', 20480, NULL, NULL, 1499, 30, 'Y', 1199, DATE '2024-01-01', DATE '2024-06-30');
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_packages (package_code, package_name, description, package_type, data_allocation_mb, voice_minutes, sms_count, price, validity_days, is_promotional, promo_price, promo_start_date, promo_end_date)
  VALUES ('VOICE-50MIN', '50 Minutes Anytime', '50 minutes to any network', 'Voice Only', NULL, 50, NULL, 50, 30, 'N', NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_packages (package_code, package_name, description, package_type, data_allocation_mb, voice_minutes, sms_count, price, validity_days, is_promotional, promo_price, promo_start_date, promo_end_date)
  VALUES ('VOICE-100MIN', '100 Minutes Anytime', '100 minutes to any network', 'Voice Only', NULL, 100, NULL, 90, 30, 'N', NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_packages (package_code, package_name, description, package_type, data_allocation_mb, voice_minutes, sms_count, price, validity_days, is_promotional, promo_price, promo_start_date, promo_end_date)
  VALUES ('VOICE-250MIN', '250 Minutes Anytime', '250 minutes to any network', 'Voice Only', NULL, 250, NULL, 200, 30, 'N', NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_packages (package_code, package_name, description, package_type, data_allocation_mb, voice_minutes, sms_count, price, validity_days, is_promotional, promo_price, promo_start_date, promo_end_date)
  VALUES ('SMS-100', '100 SMS Bundle', '100 SMS to any network', 'SMS Only', NULL, NULL, 100, 25, 30, 'N', NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_packages (package_code, package_name, description, package_type, data_allocation_mb, voice_minutes, sms_count, price, validity_days, is_promotional, promo_price, promo_start_date, promo_end_date)
  VALUES ('SMS-250', '250 SMS Bundle', '250 SMS to any network', 'SMS Only', NULL, NULL, 250, 50, 30, 'N', NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_packages (package_code, package_name, description, package_type, data_allocation_mb, voice_minutes, sms_count, price, validity_days, is_promotional, promo_price, promo_start_date, promo_end_date)
  VALUES ('COMBO-SMART-S', 'Smart Combo S', '500MB + 50min + 50SMS', 'Combo', 500, 50, 50, 99, 30, 'N', NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_packages (package_code, package_name, description, package_type, data_allocation_mb, voice_minutes, sms_count, price, validity_days, is_promotional, promo_price, promo_start_date, promo_end_date)
  VALUES ('COMBO-SMART-M', 'Smart Combo M', '2GB + 100min + 100SMS', 'Combo', 2048, 100, 100, 299, 30, 'N', NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_packages (package_code, package_name, description, package_type, data_allocation_mb, voice_minutes, sms_count, price, validity_days, is_promotional, promo_price, promo_start_date, promo_end_date)
  VALUES ('COMBO-SMART-L', 'Smart Combo L', '5GB + 250min + 200SMS', 'Combo', 5120, 250, 200, 599, 30, 'N', NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
...
BEGIN
  INSERT INTO vodacom_packages (package_code, package_name, description, package_type, data_allocation_mb, voice_minutes, sms_count, price, validity_days, is_promotional, promo_price, promo_start_date, promo_end_date)
  VALUES ('CONTRACT-RED-1G', 'Red Contract 1GB', 'Monthly contract: 1GB + Unlimited calls + 200 SMS', 'Contract', 1024, 9999, 200, 299, NULL, 'N', NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_packages (package_code, package_name, description, package_type, data_allocation_mb, voice_minutes, sms_count, price, validity_days, is_promotional, promo_price, promo_start_date, promo_end_date)
  VALUES ('CONTRACT-RED-2G', 'Red Contract 2GB', 'Monthly contract: 2GB + Unlimited calls + 500 SMS', 'Contract', 2048, 9999, 500, 399, NULL, 'N', NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_packages (package_code, package_name, description, package_type, data_allocation_mb, voice_minutes, sms_count, price, validity_days, is_promotional, promo_price, promo_start_date, promo_end_date)
  VALUES ('CONTRACT-RED-5G', 'Red Contract 5GB', 'Monthly contract: 5GB + Unlimited calls + 1000 SMS', 'Contract', 5120, 9999, 1000, 599, NULL, 'N', NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
...
BEGIN
  INSERT INTO vodacom_transactions (transaction_ref, customer_id, mobile_number, transaction_type, amount, payment_method, package_id, processed_by, transaction_date, status, channel)
  VALUES ('TXN-2024-00001', 1, '0821234567', 'Package Purchase', 999, 'Card', 18, NULL, TIMESTAMP '2024-01-05 10:15:30', 'Completed', 'App');
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_transactions (transaction_ref, customer_id, mobile_number, transaction_type, amount, payment_method, package_id, processed_by, transaction_date, status, channel)
  VALUES ('TXN-2024-00002', 2, '0839876543', 'Airtime Purchase', 50, 'Cash', NULL, NULL, TIMESTAMP '2024-01-08 14:22:15', 'Completed', 'Store');
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_transactions (transaction_ref, customer_id, mobile_number, transaction_type, amount, payment_method, package_id, processed_by, transaction_date, status, channel)
  VALUES ('TXN-2024-00003', 3, '0765432109', 'Data Purchase', 149, 'VodaPay', 5, NULL, TIMESTAMP '2024-01-10 09:45:00', 'Completed', 'USSD');
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_transactions (transaction_ref, customer_id, mobile_number, transaction_type, amount, payment_method, package_id, processed_by, transaction_date, status, channel)
  VALUES ('TXN-2024-00004', 4, '0734567890', 'Airtime Purchase', 20, 'Cash', NULL, 14, TIMESTAMP '2024-01-12 16:30:45', 'Completed', 'Store');
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_transactions (transaction_ref, customer_id, mobile_number, transaction_type, amount, payment_method, package_id, processed_by, transaction_date, status, channel)
  VALUES ('TXN-2024-00005', 9, '0789012345', 'Data Purchase', 75, 'Card', 3, NULL, TIMESTAMP '2024-01-15 11:20:30', 'Completed', 'Web');
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_transactions (transaction_ref, customer_id, mobile_number, transaction_type, amount, payment_method, package_id, processed_by, transaction_date, status, channel)
  VALUES ('TXN-2024-00006', 1, NULL, 'VodaPay Transfer', 500, 'VodaPay', NULL, NULL, TIMESTAMP '2024-01-18 13:05:20', 'Completed', 'App');
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_transactions (transaction_ref, customer_id, mobile_number, transaction_type, amount, payment_method, package_id, processed_by, transaction_date, status, channel)
  VALUES ('TXN-2024-00007', 10, '0736789012', 'Data Purchase', 249, 'VodaPay', 6, NULL, TIMESTAMP '2024-01-20 08:15:00', 'Completed', 'App');
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_transactions (transaction_ref, customer_id, mobile_number, transaction_type, amount, payment_method, package_id, processed_by, transaction_date, status, channel)
  VALUES ('TXN-2024-00008', 3, NULL, 'VodaPay Purchase', 350, 'VodaPay', NULL, NULL, TIMESTAMP '2024-01-22 17:40:15', 'Completed', 'App');
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_transactions (transaction_ref, customer_id, mobile_number, transaction_type, amount, payment_method, package_id, processed_by, transaction_date, status, channel)
  VALUES ('TXN-2024-00009', 11, '0821231234', 'Airtime Purchase', 100, 'Card', NULL, NULL, TIMESTAMP '2024-01-25 12:30:00', 'Completed', 'Web');
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_transactions (transaction_ref, customer_id, mobile_number, transaction_type, amount, payment_method, package_id, processed_by, transaction_date, status, channel)
  VALUES ('TXN-2024-00010', 13, '0756781234', 'Package Purchase', 599, 'Direct Debit', 17, NULL, TIMESTAMP '2024-01-28 10:00:00', 'Completed', 'App');
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_transactions (transaction_ref, customer_id, mobile_number, transaction_type, amount, payment_method, package_id, processed_by, transaction_date, status, channel)
  VALUES ('TXN-2024-00011', 2, '0839876543', 'Airtime Purchase', 30, 'Voucher', NULL, NULL, TIMESTAMP '2024-02-01 15:45:30', 'Completed', 'USSD');
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_transactions (transaction_ref, customer_id, mobile_number, transaction_type, amount, payment_method, package_id, processed_by, transaction_date, status, channel)
  VALUES ('TXN-2024-00012', 15, '0789011111', 'Data Purchase', 499, 'Card', 7, NULL, TIMESTAMP '2024-02-03 09:20:15', 'Completed', 'App');
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_transactions (transaction_ref, customer_id, mobile_number, transaction_type, amount, payment_method, package_id, processed_by, transaction_date, status, channel)
  VALUES ('TXN-2024-00013', 5, NULL, 'Bill Payment', 850, 'VodaPay', NULL, NULL, TIMESTAMP '2024-02-05 14:10:00', 'Completed', 'App');
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_transactions (transaction_ref, customer_id, mobile_number, transaction_type, amount, payment_method, package_id, processed_by, transaction_date, status, channel)
  VALUES ('TXN-2024-00014', 16, '0821112222', 'Package Purchase', 999, 'Card', 18, NULL, TIMESTAMP '2024-02-08 11:35:45', 'Completed', 'Web');
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_transactions (transaction_ref, customer_id, mobile_number, transaction_type, amount, payment_method, package_id, processed_by, transaction_date, status, channel)
  VALUES ('TXN-2024-00015', 19, '0733334444', 'Airtime Purchase', 15, 'Cash', NULL, 12, TIMESTAMP '2024-02-10 16:50:20', 'Completed', 'Store');
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
...
BEGIN
  INSERT INTO vodacom_network_towers (tower_code, tower_name, latitude, longitude, province, city, tower_type, capacity, installation_date, monthly_cost, owner_type)
...
BEGIN
  INSERT INTO vodacom_network_issues (issue_ref, tower_id, issue_type, severity, description, province, city, affected_customers, reported_date, status, assigned_to)
  VALUES ('INC-2024-001', 1, 'Maintenance', 'Low', 'Scheduled upgrade to 5G equipment', 'Gauteng', 'Johannesburg', 0, TIMESTAMP '2024-02-15 02:00:00', 'Resolved', NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
...
BEGIN
  INSERT INTO vodacom_network_issues (issue_ref, tower_id, issue_type, severity, description, province, city, affected_customers, reported_date, status, assigned_to)
  VALUES ('INC-2024-004', NULL, 'Weather Damage', 'Medium', 'Lightning damage to fiber connection', 'Free State', 'Bloemfontein', 1200, TIMESTAMP '2024-02-12 18:45:00', 'Resolved', NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
...
BEGIN
  INSERT INTO vodacom_customer_support (ticket_number, customer_id, mobile_number, issue_category, issue_type, description, priority, status, channel, assigned_to, resolved_date, resolution, customer_satisfaction)
  VALUES ('TKT-2024-00001', 1, '0821234567', 'Billing', 'Incorrect Charge', 'Charged twice for the same data bundle purchase', 'High', 'Open', 'Call Center', 2, NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
...
BEGIN
  INSERT INTO vodacom_customer_support (ticket_number, customer_id, mobile_number, issue_category, issue_type, description, priority, status, channel, assigned_to, resolved_date, resolution, customer_satisfaction)
  VALUES ('TKT-2024-00003', 4, '0734567890', 'Technical', 'Data Not Working', 'Purchased data but cannot browse internet', 'Normal', 'In Progress', 'Call Center', 4, NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
...
BEGIN
  INSERT INTO vodacom_customer_support (ticket_number, customer_id, mobile_number, issue_category, issue_type, description, priority, status, channel, assigned_to, resolved_date, resolution, customer_satisfaction)
  VALUES ('TKT-2024-00005', 1, NULL, 'VodaPay', 'Transaction Failed', 'VodaPay transfer failed but amount was deducted', 'Urgent', 'Open', 'App', 28, NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_customer_support (ticket_number, customer_id, mobile_number, issue_category, issue_type, description, priority, status, channel, assigned_to, resolved_date, resolution, customer_satisfaction)
  VALUES ('TKT-2024-00006', 9, '0789012345', 'Billing', 'Invoice Query', 'Requesting breakdown of last month charges', 'Normal', 'Assigned', 'Email', 16, NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
...
BEGIN
  INSERT INTO vodacom_customer_support (ticket_number, customer_id, mobile_number, issue_category, issue_type, description, priority, status, channel, assigned_to, resolved_date, resolution, customer_satisfaction)
  VALUES ('TKT-2024-00008', 15, '0789011111', 'Query', 'Package Information', 'Want to know about available monthly packages', 'Low', 'Open', 'Social Media', NULL, NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_customer_support (ticket_number, customer_id, mobile_number, issue_category, issue_type, description, priority, status, channel, assigned_to, resolved_date, resolution, customer_satisfaction)
  VALUES ('TKT-2024-00009', 16, '0821112222', 'Technical', 'SIM Card Issue', 'SIM card not detected by phone', 'High', 'In Progress', 'Walk-in', 3, NULL, NULL, NULL);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_customer_support (ticket_number, customer_id, mobile_number, issue_category, issue_type, description, priority, status, channel, assigned_to, resolved_date, resolution, customer_satisfaction)
  VALUES ('TKT-2024-00010', 5, NULL, 'Request', 'Upgrade Package', 'Want to upgrade to higher data package', 'Normal', 'Closed', 'App', 11, TIMESTAMP '2024-02-05 11:15:00', 'Customer upgraded to Smart L package successfully', 5);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
...
BEGIN
  INSERT INTO vodacom_sales (sale_ref, customer_id, sale_date, sale_type, product_name, quantity, unit_price, discount_percent, discount_amount, total_amount, payment_method, sales_agent_id, commission_amount, branch_code)
...
BEGIN
  INSERT INTO vodacom_vodapay_accounts (customer_id, wallet_number, linked_mobile, balance, daily_limit, monthly_limit, kyc_verified, activation_date, total_spent, total_received)
...
BEGIN
  INSERT INTO vodacom_invoices (invoice_number, customer_id, mobile_number, invoice_date, due_date, billing_period, subtotal, vat_amount, total_amount, amount_paid, balance, status, payment_date, generated_by)
  VALUES ('INV-2024-01-001', 1, '0821234567', DATE '2024-01-31', DATE '2024-02-15', 'January 2024', 869.57, 130.43, 1000.00, 1000.00, 0, 'Paid', DATE '2024-02-08', 16);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_invoices (invoice_number, customer_id, mobile_number, invoice_date, due_date, billing_period, subtotal, vat_amount, total_amount, amount_paid, balance, status, payment_date, generated_by)
  VALUES ('INV-2024-01-002', 3, '0765432109', DATE '2024-01-31', DATE '2024-02-15', 'January 2024', 521.74, 78.26, 600.00, 600.00, 0, 'Paid', DATE '2024-02-05', 16);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
...
BEGIN
  INSERT INTO vodacom_invoices (invoice_number, customer_id, mobile_number, invoice_date, due_date, billing_period, subtotal, vat_amount, total_amount, amount_paid, balance, status, payment_date, generated_by)
  VALUES ('INV-2024-01-004', 13, '0756781234', DATE '2024-01-31', DATE '2024-02-15', 'January 2024', 434.78, 65.22, 500.00, 0, 500.00, 'Issued', NULL, 16);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_invoices (invoice_number, customer_id, mobile_number, invoice_date, due_date, billing_period, subtotal, vat_amount, total_amount, amount_paid, balance, status, payment_date, generated_by)
  VALUES ('INV-2024-01-005', 16, '0821112222', DATE '2024-01-31', DATE '2024-02-15', 'January 2024', 1043.48, 156.52, 1200.00, 0, 1200.00, 'Issued', NULL, 16);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
  INSERT INTO vodacom_invoices (invoice_number, customer_id, mobile_number, invoice_date, due_date, billing_period, subtotal, vat_amount, total_amount, amount_paid, balance, status, payment_date, generated_by)
  VALUES ('INV-2024-01-006', 21, '0826667777', DATE '2024-01-31', DATE '2024-02-15', 'January 2024', 782.61, 117.39, 900.00, 450.00, 450.00, 'Partially Paid', NULL, 16);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
...
BEGIN
  INSERT INTO vodacom_invoice_items (invoice_id, item_type, description, quantity, unit_price, amount)
...
BEGIN
  INSERT INTO vodacom_invoice_items (invoice_id, item_type, description, quantity, unit_price, amount)
  VALUES (1, 'Voice Calls', 'Out-of-bundle calls', NULL, NULL, 1.00);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
...
BEGIN
  INSERT INTO vodacom_invoice_items (invoice_id, item_type, description, quantity, unit_price, amount)
  VALUES (2, 'SMS Charges', 'Additional SMS', NULL, NULL, 75.24);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
...
BEGIN
  INSERT INTO vodacom_invoice_items (invoice_id, item_type, description, quantity, unit_price, amount)
  VALUES (3, 'International Calls', 'International calls', NULL, NULL, 5.65);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
...
BEGIN
  INSERT INTO vodacom_invoice_items (invoice_id, item_type, description, quantity, unit_price, amount)
  VALUES (4, 'Value Added Services', 'Music streaming service', NULL, NULL, 52.28);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
...
BEGIN
  INSERT INTO vodacom_invoice_items (invoice_id, item_type, description, quantity, unit_price, amount)
  VALUES (5, 'Data Usage', 'Out-of-bundle data', NULL, NULL, 54.48);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
BEGIN
...
BEGIN
  INSERT INTO vodacom_invoice_items (invoice_id, item_type, description, quantity, unit_price, amount)
  VALUES (6, 'Roaming', 'Data roaming charges', NULL, NULL, 105.41);
EXCEPTION WHEN DUP_VAL_ON_INDEX THEN NULL;
END;
/
...
-- ============================================================================
-- Data re-insertion check removed: all data inserted above via INSERT ALL blocks
-- ============================================================================
...
BEGIN
    ...
    IF v_errors > 0 THEN
        ...
        DBMS_OUTPUT.PUT_LINE('⚠ Please review and re-run the script if needed.');
