-- ============================================================================
-- Lab 04 Standalone SQL Setup - Reports and Forms (Vodacom)
-- ============================================================================
...
-- This creates all tables and data needed for Lab 04.
--
-- TABLES CREATED: vodacom_departments, vodacom_employees, vodacom_customers,
--   vodacom_mobile_numbers, vodacom_packages, vodacom_transactions,
--   vodacom_customer_support, vodacom_vodapay_accounts, vodacom_invoices,
...
CREATE TABLE vodacom_departments (
    dept_id NUMBER PRIMARY KEY, dept_name VARCHAR2(100) NOT NULL UNIQUE, dept_code VARCHAR2(20) NOT NULL UNIQUE,
    manager_id NUMBER, budget NUMBER(14,2), location VARCHAR2(100), cost_center VARCHAR2(50),
    is_active VARCHAR2(1) DEFAULT 'Y', created_date DATE DEFAULT SYSDATE, created_by VARCHAR2(100) DEFAULT USER,
    modified_date DATE, modified_by VARCHAR2(100)
);

CREATE TABLE vodacom_employees (
    emp_id NUMBER PRIMARY KEY, first_name VARCHAR2(50) NOT NULL, last_name VARCHAR2(50) NOT NULL,
    email VARCHAR2(100) NOT NULL UNIQUE, phone VARCHAR2(20) NOT NULL, mobile_number VARCHAR2(20),
    hire_date DATE NOT NULL, dept_id NUMBER NOT NULL, job_title VARCHAR2(100) NOT NULL,
    manager_id NUMBER, salary NUMBER(10,2), employee_type VARCHAR2(20) DEFAULT 'Permanent',
    status VARCHAR2(20) DEFAULT 'Active', employee_number VARCHAR2(20) NOT NULL UNIQUE,
    branch_code VARCHAR2(20), commission_rate NUMBER(5,2), created_date DATE DEFAULT SYSDATE
);

CREATE TABLE vodacom_customers (
    customer_id NUMBER PRIMARY KEY, account_number VARCHAR2(20) NOT NULL UNIQUE,
    first_name VARCHAR2(50) NOT NULL, last_name VARCHAR2(50) NOT NULL,
    id_number VARCHAR2(20) NOT NULL UNIQUE, email VARCHAR2(100), phone VARCHAR2(20) NOT NULL,
    alternate_phone VARCHAR2(20), address_line1 VARCHAR2(200), address_line2 VARCHAR2(200),
    city VARCHAR2(100), province VARCHAR2(50), postal_code VARCHAR2(10),
    customer_type VARCHAR2(20) DEFAULT 'Individual', account_status VARCHAR2(20) DEFAULT 'Active',
    credit_limit NUMBER(10,2) DEFAULT 0, registration_date DATE DEFAULT SYSDATE, last_updated DATE,
    assigned_agent_id NUMBER, vodapay_active VARCHAR2(1) DEFAULT 'N', created_date DATE DEFAULT SYSDATE
);

CREATE TABLE vodacom_mobile_numbers (
    number_id NUMBER PRIMARY KEY, mobile_number VARCHAR2(20) NOT NULL UNIQUE, customer_id NUMBER NOT NULL,
    number_type VARCHAR2(20) DEFAULT 'Prepaid', sim_card_number VARCHAR2(50) UNIQUE,
    activation_date DATE NOT NULL, expiry_date DATE, status VARCHAR2(20) DEFAULT 'Active',
    current_package VARCHAR2(100), monthly_fee NUMBER(8,2) DEFAULT 0,
    data_balance_mb NUMBER(10,2) DEFAULT 0, airtime_balance NUMBER(8,2) DEFAULT 0,
    sms_balance NUMBER(6,0) DEFAULT 0, last_recharge_date DATE, last_usage_date DATE,
    created_date DATE DEFAULT SYSDATE
);

CREATE TABLE vodacom_packages (
    package_id NUMBER PRIMARY KEY, package_code VARCHAR2(20) NOT NULL UNIQUE,
    package_name VARCHAR2(100) NOT NULL, description VARCHAR2(500),
    package_type VARCHAR2(30) NOT NULL, data_allocation_mb NUMBER(10,2),
    voice_minutes NUMBER(6,0), sms_count NUMBER(6,0), price NUMBER(8,2) NOT NULL,
    validity_days NUMBER(4,0), is_active VARCHAR2(1) DEFAULT 'Y',
    is_promotional VARCHAR2(1) DEFAULT 'N', promo_price NUMBER(8,2),
    promo_start_date DATE, promo_end_date DATE, created_date DATE DEFAULT SYSDATE
);

CREATE TABLE vodacom_transactions (
    transaction_id NUMBER PRIMARY KEY, transaction_ref VARCHAR2(30) NOT NULL UNIQUE,
    customer_id NUMBER NOT NULL, mobile_number VARCHAR2(20), transaction_type VARCHAR2(30) NOT NULL,
    amount NUMBER(10,2) NOT NULL, payment_method VARCHAR2(30) NOT NULL, package_id NUMBER,
    transaction_date TIMESTAMP DEFAULT SYSTIMESTAMP, status VARCHAR2(20) DEFAULT 'Completed',
    processed_by NUMBER, channel VARCHAR2(30), notes VARCHAR2(500), created_date DATE DEFAULT SYSDATE
);

CREATE TABLE vodacom_customer_support (
    ticket_id NUMBER PRIMARY KEY, ticket_number VARCHAR2(30) NOT NULL UNIQUE, customer_id NUMBER NOT NULL,
    mobile_number VARCHAR2(20), issue_category VARCHAR2(50) NOT NULL, issue_type VARCHAR2(100) NOT NULL,
    description VARCHAR2(2000) NOT NULL, priority VARCHAR2(20) DEFAULT 'Normal',
    status VARCHAR2(20) DEFAULT 'Open', channel VARCHAR2(30),
    created_date TIMESTAMP DEFAULT SYSTIMESTAMP, assigned_to NUMBER, assigned_date TIMESTAMP,
    resolved_date TIMESTAMP, closed_date TIMESTAMP, resolution VARCHAR2(2000),
    customer_satisfaction NUMBER(1,0)
);

CREATE TABLE vodacom_vodapay_accounts (
    vodapay_id NUMBER PRIMARY KEY, customer_id NUMBER NOT NULL UNIQUE,
    wallet_number VARCHAR2(20) NOT NULL UNIQUE, linked_mobile VARCHAR2(20) NOT NULL,
    balance NUMBER(10,2) DEFAULT 0, daily_limit NUMBER(10,2) DEFAULT 5000,
    monthly_limit NUMBER(10,2) DEFAULT 50000, status VARCHAR2(20) DEFAULT 'Active',
    kyc_verified VARCHAR2(1) DEFAULT 'N', activation_date DATE, last_transaction DATE,
    total_spent NUMBER(12,2) DEFAULT 0, total_received NUMBER(12,2) DEFAULT 0,
    created_date DATE DEFAULT SYSDATE
);

CREATE TABLE vodacom_invoices (
    invoice_id NUMBER PRIMARY KEY, invoice_number VARCHAR2(30) NOT NULL UNIQUE,
    customer_id NUMBER NOT NULL, mobile_number VARCHAR2(20), invoice_date DATE NOT NULL,
    due_date DATE NOT NULL, billing_period VARCHAR2(50) NOT NULL,
    subtotal NUMBER(10,2) NOT NULL, vat_amount NUMBER(10,2) NOT NULL,
    total_amount NUMBER(10,2) NOT NULL, amount_paid NUMBER(10,2) DEFAULT 0,
    balance NUMBER(10,2), status VARCHAR2(20) DEFAULT 'Issued', payment_date DATE,
    generated_by NUMBER, notes VARCHAR2(500), created_date DATE DEFAULT SYSDATE
);

CREATE TABLE vodacom_invoice_items (
    item_id NUMBER PRIMARY KEY, invoice_id NUMBER NOT NULL, item_type VARCHAR2(50) NOT NULL,
    description VARCHAR2(200) NOT NULL, quantity NUMBER(10,2), unit_price NUMBER(10,2),
    amount NUMBER(10,2) NOT NULL, created_date DATE DEFAULT SYSDATE
);

-- ============================================================================
-- INSERT DATA: Departments (8)
-- ============================================================================
...
-- ============================================================================
-- INSERT DATA: Customer Support (10)
-- ============================================================================
...
INSERT INTO vodacom_customer_support (ticket_id, ticket_number, customer_id, mobile_number, issue_category, issue_type, description, priority, status, channel) VALUES (8, 'TKT-2024-00008', 15, '0789011111', 'Query', 'Package Information', 'Want to know about available monthly packages', 'Low', 'Open', 'Social Media');
...
-- ============================================================================
-- INSERT DATA: VodaPay Accounts (9)
-- ============================================================================
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('Lab 04 Setup Verification');
    DBMS_OUTPUT.PUT_LINE('============================================');
    ...
    DBMS_OUTPUT.PUT_LINE('============================================');
    DBMS_OUTPUT.PUT_LINE('Lab 04 setup complete!');
    DBMS_OUTPUT.PUT_LINE('============================================');
END;
/
